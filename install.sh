...
python3 -m pip install wandb smart-open[gcs] jsonpickle sharedutils git+https://github.com/ytdl-org/youtube-dl/ typer diffusers==0.12.1 flax optax ffmpeg-python huggingface-hub transformers gdown torch torchvision opencv-python ftfy
